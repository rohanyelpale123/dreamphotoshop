let showbtn = document.queryselector('.navBtn');
let top-nav = document .queryselector('.top-nav');
showbtn.addEventlistener('click', function(){
	if (top-nav.classlist.contains('shownav')) {
		top-nav.classlist.remove('shownav');
